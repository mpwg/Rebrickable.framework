...
public enum LegoError: Error {
    ...
    var message: String {
        switch self {
        case .decode: ""
        case .formatRequestWrong: "Something was wrong with the format of your request"
        case .invalidApiKey: "Unauthorized - your API key is invalid"
        case .notItemAccess: "Forbidden - you do not have access to operate on the requested item(s)"
        case .itemNotFound: "Item not found"
        case .throttledRequest: "Request was throttled. Expected available in 2 seconds."
